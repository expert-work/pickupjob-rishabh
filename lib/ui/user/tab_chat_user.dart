...
class TabChatUser extends StatefulWidget {
  const TabChatUser({super.key});

  @override
  State<TabChatUser> createState() => _TabChatUserState();
}

class _TabChatUserState extends State<TabChatUser> {
  @override
                  ...
                  builder: (ChatListController chatListController) {
                    return Container(
                      ...
                      child: ListView.builder(
                        itemCount: chatListController.chatLists_user.length,
                        itemBuilder: (BuildContext context, int index) {
                          print(chatListController.chatLists_user[index]);
                          final chatListData =
                              chatListController.chatLists_user[index];
                          return Container(
                              padding: EdgeInsets.all(15),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image.network(
                                          chatListData.driver_image.toString(),
                                      ...
                                      Container(
                                        width:
                                            MediaQuery.of(context).size.width *
                                                ...
                                                80,
                                        child: Text(
                                          chatListData.driver_name.toString() +
                                              ' - ' +

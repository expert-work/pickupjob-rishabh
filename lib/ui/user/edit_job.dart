...
class editPickupJobs extends StatefulWidget {
  const editPickupJobs({super.key});

  @override
  State<editPickupJobs> createState() => _editPickupJobsState();
}

class _editPickupJobsState extends State<editPickupJobs> {
...
//MAP
  ...
  void initState() {
    ...
    pickAddressController.text = argumentData['pickAddress'];
    pickStateController.text = argumentData['pickState'];
    pickCityController.text = argumentData['pickCity'];
    pickZipController.text = argumentData['pickZip'];

    dropAddressController.text = argumentData['dropAddress'];
    dropStateController.text = argumentData['dropState'];
    dropCityController.text = argumentData['dropCity'];
    dropZipController.text = argumentData['dropZip'];

    contactPersonNameController.text = argumentData['contactPersonName'];
    contactPersonMobileController.text = argumentData['contactPersonMobile'];
    ...
    contactPersonAlternateMobile = argumentData['contactPersonAlternateMobile'];
                  ...
                  onPressed: () {
                    ...
                    if (!isError) {
                      ...
                      setState(() {
                        ...
                        setLocations(pickLat, pickLan, pickAddress, 'pick');
                ...
                onPressed: () {
                  ...
                  if (!isError) {
                    setState(() {
                      ...
                      setLocations(dropLat, dropLan, dropAddress, 'drop');
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  PickUpJobModel job = PickUpJobModel(
                    ...
                    status: 'Open',
                    amount: 0,
                    bid_id: argumentData['vehicle_name'],
                    driver_id: argumentData['vehicle_name'],
                    driver_name: argumentData['vehicle_name'],
                    vehicle_id: argumentData['vehicle_name'],
                  ...
                  await FirestoreDb.editPickupJobs(job);
                  hideLoadingIndicator();
                  Get.offAll(ListPickUpJob());
                },
                child: const Text(
                  'Save Order',
                  style: TextStyle(color: Colors.white, fontSize: 25),
